...
// const recursionPattern = (int1, int2) => {
   ...
   //when i use recursion the test give me an error for too many loops inside recursion so i find this solution.
    // RangeError: Maximum call stack size exceeded
    //     at Array.push (<anonymous>)
    //   const recursionPattern = (n, k, arr = []) => {
    //     arr.push(n);
    //     if (n < 0) {
    //       arr.pop();
    //       return recursionPattern(n + k, k, arr);
    //     } else if (n === 0) {
    //       arr.push(n);
    //       return arr;
    //     } else {
...
const isPalindrome = (str) => {
    // write your code here
        ...
        // Check if cleanStr reads the same forward and backward
