...
const objLat = (obj) => {
    ...
    let FirstN = obj.firstName.charAt(0).toUpperCase() + obj.firstName.slice(1);
    let LastN = obj.lastName.charAt(0).toUpperCase() + obj.lastName.slice(1);
    return "my name is " + FirstN + " " + LastN + " I am " + obj.age + " YO, and I love " + obj.hobby + ".";
...
const cvFormatter = (arr) => {
    ...
    for (let i = 0; i < arr.length; i++) {
        if (arr[i].yearsOfExperience > 1) {
            return { fullName: cvs.fullName, tech: cvs.tech };
        } else {
            return null;
